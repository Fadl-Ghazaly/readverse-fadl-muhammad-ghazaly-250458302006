...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        ...
        @enderror
            ...
            {{-- Cover Baru --}}
            <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Cover Baru</label>
                <div class="col-sm-10">
                    ...
                    @if($old_cover)
                        <div class="mt-2">
                            <p class="mb-1">Cover saat ini:</p>
                            <img src="{{ asset('storage/' . $old_cover) }}" width="120" class="rounded border">
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-sm-10 offset-sm-2">
                    ...
                    <button type="button" class="btn btn-secondary" wire:click="$set('isEdit', false)">
                        Batal
                    </button>
                </div>
            </div>
